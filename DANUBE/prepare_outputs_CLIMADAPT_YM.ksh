...
# YEARLY MAX
cdo yearmax ${VAR}_BCed_1961_${YEND}_022.nc ${VAR}_BCed_1961_${YEND}_022_YMAX.nc
ncks -d lon,${lon1},${lon2} -d lat,${lat1},${lat2} ${VAR}_BCed_1961_${YEND}_022_YMAX.nc ${OPATH}/${VAR}_BCed_${JOB_ID}_${CASE}_1961_${YEND}_022_YMAX_COM.nc
