;;THIS IDL FUNCTION PRODUCES A NETCDF FILE WITH A COMPRESSED WFD FORMAT
...
; nxx     - number of x-values in the original OBS
; nyy     - number of y-values in the original OBS
; yr      - starting year
...
; navlon  - the array of longitude values from the original OBS
; navlat  - the array of latitude values from the original OBS
