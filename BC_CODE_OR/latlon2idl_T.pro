...
type=['12523_E23'];, '12524_E24', '31009_S09']
;month=['12']
varname=['t2min','t2max'];['temp2']; 'temp2' ; aprl
;varname=['temp2']
fileRoot=['TMIN','TMAX'];['T'];
;fileRoot=['T'];['T'];
multfactor=1.0
;multfactor=86400
;
...
;*******************************************************************
save,filename=pathdat+'modelData/'+varname(vn)+'_'+START+'_'+STOP+'_'+month(mon)+'_'+type(typ)+'.dat',$
              outdataarray
;
endfor ; loop over months
;
endfor ; loop over varnames
;
endfor ; loop over model runs
;
close,2
end
