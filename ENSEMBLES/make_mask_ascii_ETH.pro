pro make_mask_ascii_DMI  ;infile,loopend
...
;READ_CONSTANT_FIELDS
	c_file='/media/disk/ENSEMBLES/DMI-HIRHAM/input/DMI-HIRHAM_CTL_ERA40_FIX_orog.nc' ;ens044ns044
iLUN=10
...
;read data
     tmpfield=fltarr(tnx,tny)
         ...
         IF (vardata.Name EQ 'oro') THEN HSURF=tmpfield
ENDFOR
NCDF_CLOSE, ncid
