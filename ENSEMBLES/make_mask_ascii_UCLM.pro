pro make_mask_ascii_UCLM  ;infile,loopend
...
;read data
     tmpfield=fltarr(tnx,tny)
         ...
         IF (vardata.Name EQ 'lon') THEN lonx=tmpfield
         IF (vardata.Name EQ 'lat') THEN laty=tmpfield
...
contour,hsurf,levels=levels,c_colors=colors,lonx,laty,/fill,xstyle=1,ystyle=1,/overplot
map_grid,color=0
