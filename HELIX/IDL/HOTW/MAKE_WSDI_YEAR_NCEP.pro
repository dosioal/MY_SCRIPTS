...
LM_FILE='/media/NAS/LUC/SMHI/LR/'+FILE_LAND
...
close,1
openr,1,'/media/NAS/LUC/SMHI/LR/lon_05.txt'
WORK=FLTARR(nx)
...
openr,1,'/media/NAS/LUC/SMHI/LR/lat_05.txt'
WORK=FLTARR(nx)
FOR iy=0,ny-1 DO BEGIN
readf,1,work
lat(*,iy)=WORK
...
;OPEN TXx FILE
DATA_FILE=DIR_TXx+VAR+'_p25_TXx_1979_2005.nc'
print,'PERC FILE = ',DATA_FILE
fileID = NCDF_Open(DATA_FILE)
varID = NCDF_VarID(fileID, VAR_F)
varInfo = NCDF_VarInq(fileID, varID)
dimIDs = varInfo.dim
nDims = N_Elements(dimIDs)
dims_a = IntArr(nDims)
...
;OPEN TXx FILE
DATA_FILE=DIR_TXx+VAR+'_p75_TXx_1979_2005.nc'
print,'PERC FILE = ',DATA_FILE
fileID = NCDF_Open(DATA_FILE)
varID = NCDF_VarID(fileID, VAR_F)
varInfo = NCDF_VarInq(fileID, varID)
...
FILE_RUN=VAR+'_'+STRMID(YEAR_INI,4)+'_'+STRMID(YEAR_END,4)+'.nc'  ;CLIMATOLOGICAL 
FILE_SHIFT=VAR+'_'+STRMID(YEAR_INI,4)+'_'+STRMID(YEAR_END,4)+'_shift.nc'  
