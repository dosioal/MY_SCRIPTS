...
pp=POLYGON([1976,2005,2005,1976],[-1,-1,1,1],/DATA,/FILL_BACKGROUND, COLOR="gray",FILL_COLOR="gray",FILL_TRANSPARENCY=80,TARGET=p)
t=TEXT(1976,1.1,'Reference period',/DATA,FONT_SIZE=12,COLOR="black",TARGET=p) 
...
a1=ARROW([2005,2005],[T_2005-T_REF-0.8,T_2005-T_REF],/DATA,color="black",TARGET=p,THICK=1,ARROW_STYLE=3)
t=TEXT(2006,-0.3,'+0.8$\circ$C',/DATA,FONT_SIZE=12,COLOR="black",TARGET=p)  
...
w1.Save,'./PLOTS/PLOT_METHOD_2C.pdf',BITMAP=1,PAGE_SIZE="A4"
STOP
