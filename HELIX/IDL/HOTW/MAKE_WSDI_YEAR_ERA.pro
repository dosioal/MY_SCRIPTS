...
FILE_RUN=VAR+'_'+STRMID(YEAR_INI,4)+'_2010_0.5.nc'  ;CLIMATOLOGICAL PERCENTILES
...
spawn,'mv '+ DIR_WORK+'/test_*.nc2 '+DIR_RUN+'YEAR/'
ENDIF
...
FILE_SHIFT=VAR+'_'+STRMID(YEAR_INI,4)+'_2010_0.5_an_shift.nc'  ; CLIMATOLOGICAL  ANOMALY
FILE_EX=FINDFILE(DIR_RUN+FILE_SHIFT,count=count)
...
spawn,'mv '+ DIR_WORK+'/test_an_*.nc2 '+DIR_RUN+'YEAR/'
ENDIF
ENDELSE
...
;OPEN FILE
IF STAT EQ 'SM' OR STAT EQ 'HWMId' THEN DATA_FILE=DIR_RUN+'YEAR/test_'+STRMID(YI,4)+'.nc2' ELSE DATA_FILE=DIR_RUN+'YEAR/test_an_'+STRMID(YI,4)+'.nc2'
