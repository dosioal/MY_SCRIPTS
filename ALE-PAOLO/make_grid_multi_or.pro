...
MODEL_ID=['ETHZ-CLM','KNMI-RACMO2']
CASE_ID=['SCN_HadCM3Q0','A1B_ECHAM5-r3']
...
ofile='DATA/OBS_'+VAR+'_'+MODEL_ID(imd)+'_'+CASE_ID(imd)+'_'+CONSTRUCTION_PERIOD_START+'_'+CONSTRUCTION_PERIOD_STOP+'_'+APPLICATION_PERIOD_START+'_'+APPLICATION_PERIOD_STOP+'_'+month(im)+'.dat'
save,filename=ofile,obs2d,nxm,nym,mx0,my0,mnx,mny,mnx0,mny0,landmask_c,mndays
...
;p_obs2d_mm=fltarr(nxm,nym,nmod)
...
;FOR iy=0,nym-1 do begin &$
;FOR imd=0,nmod-1 do begin &$
;	IF obs2d_mm(ix,iy,imd) GE 0 THEN p_obs2d_mm(ix,iy,imd)=obs2d_mm(ix,iy,imd)  &$
