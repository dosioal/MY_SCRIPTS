...
OBS_DIR=home_data+MODEL_ID(imd)+'_'+CASE_ID(imd)+'_EOBS_'+APPLICATION_PERIOD_START+'-'+APPLICATION_PERIOD_STOP+'_'+APPLICATION_PERIOD_START+'-'+APPLICATION_PERIOD_STOP+'/OBS_idl/'
MOD_DIR=home_data+MODEL_ID(imd)+'_'+CASE_ID(imd)+'_EOBS_'+APPLICATION_PERIOD_START+'-'+APPLICATION_PERIOD_STOP+'_'+APPLICATION_PERIOD_START+'-'+APPLICATION_PERIOD_STOP+'/BC_data/'
...
tasc2d(*,*,*)=!VALUES.F_NAN
tasc2d(*,*,*)=-999.
obs2d = FLTARR(nx(imd),ny(imd),ndays(im))
obs2d(*,*,*)=!VALUES.F_NAN
obs2d(*,*,*)=-999.
...
;		print,i,lon_c(i),lat_c(i)
         tas2d(lon_a(i),lat_a(i),*)=tas(i,0:NDAYS(im)-1)
         obs2d(lon_a(i),lat_a(i),*)=obs(i,0:NDAYS(im)-1)
ENDFOR
...
obs2d_m(nx0(imd):nx0(imd)+nx(imd)-1,ny0(imd):ny0(imd)+ny(imd)-1,0:NDAYS(im)-1,imd)=obs2d
...
FOR ix=0,nxm-1 do begin
	...
	obs2d_mm(ix,iy,imd)=MEAN(obs2d_m(ix,iy,*,imd),/NAN)
ENDFOR
ENDFOR
...
FOR iy=0,nym-1 do begin
FOR ix=0,nxm-1 do begin
	tas2d_ave(ix,iy,i)=MEAN(tas2d_m(ix,iy,im,*),/NAN)
	tasc2d_ave(ix,iy,i)=MEAN(tasc2d_m(ix,iy,im,*),/NAN)
ENDFOR
ENDFOR
ENDFOR
...
FOR imd=0,nmod-1 DO BEGIN &$
	...
	contour,obs2d_m(*,*,0,imd),levels=rgrContValues,/fill,c_colors=rgrColValues,xstyle=1,ystyle=1,/overplot &$
	...
	contour,tas2d_m(*,*,0,imd),levels=rgrContValues,/fill,c_colors=rgrColValues,xstyle=1,ystyle=1,/overplot &$
	contour,landmask_com,xstyle=1,ystyle=1,/overplot,thick=0.5,color=255 &$

	contour,landmask_com,xstyle=1,ystyle=1,c_colors=255,title=VAR+' CORR DJF' &$;,position=[0.05,0.55,0.45,0.95] 
	contour,tasc2d_m(*,*,0,imd),levels=rgrContValues,/fill,c_colors=rgrColValues,xstyle=1,ystyle=1,/overplot &$
	contour,landmask_com,xstyle=1,ystyle=1,/overplot,thick=0.5,color=255 &$
ENDFOR
	contour,landmask_com,xstyle=1,ystyle=1,c_colors=255,title=VAR+' OBS DJF' &$;,position=[0.05,0.55,0.45,0.95] 
	contour,obs2d_m(*,*,0,0),levels=rgrContValues,/fill,c_colors=rgrColValues,xstyle=1,ystyle=1,/overplot &$
	contour,landmask_com,xstyle=1,ystyle=1,/overplot,thick=0.5,color=255 &$

	contour,landmask_com,xstyle=1,ystyle=1,c_colors=255,title=VAR+' MODEL DJF' &$;,position=[0.05,0.55,0.45,0.95] 
	contour,tas2d_ave(*,*,0),levels=rgrContValues,/fill,c_colors=rgrColValues,xstyle=1,ystyle=1,/overplot &$
	contour,landmask_com,xstyle=1,ystyle=1,/overplot,thick=0.5,color=255 &$

	contour,landmask_com,xstyle=1,ystyle=1,c_colors=255,title=VAR+' CORR DJF' &$;,position=[0.05,0.55,0.45,0.95] 
	contour,tasc2d_ave(*,*,0),levels=rgrContValues,/fill,c_colors=rgrColValues,xstyle=1,ystyle=1,/overplot &$
	contour,landmask_com,xstyle=1,ystyle=1,/overplot,thick=0.5,color=255 &$
...
FOR imd=0,nmod-1 DO BEGIN &$
	contour,landmask_com,xstyle=1,ystyle=1,c_colors=255,title=VAR+' OBS DJF' &$;,position=[0.05,0.55,0.45,0.95] 
	contour,obs2d_mm(*,*,imd),levels=rgrContValues,/fill,c_colors=rgrColValues,xstyle=1,ystyle=1,/overplot &$
	contour,landmask_com,xstyle=1,ystyle=1,/overplot,thick=0.5,color=255 &$

	contour,landmask_com,xstyle=1,ystyle=1,c_colors=255,title=VAR+' MODEL DJF' &$;,position=[0.05,0.55,0.45,0.95] 
	contour,tas2d_mm(*,*,imd),levels=rgrContValues,/fill,c_colors=rgrColValues,xstyle=1,ystyle=1,/overplot &$
	contour,landmask_com,xstyle=1,ystyle=1,/overplot,thick=0.5,color=255 &$

	contour,landmask_com,xstyle=1,ystyle=1,c_colors=255,title=VAR+' CORR DJF' &$;,position=[0.05,0.55,0.45,0.95] 
	contour,tasc2d_mm(*,*,imd),levels=rgrContValues,/fill,c_colors=rgrColValues,xstyle=1,ystyle=1,/overplot &$
	contour,landmask_com,xstyle=1,ystyle=1,/overplot,thick=0.5,color=255 &$
ENDFOR
	contour,landmask_com,xstyle=1,ystyle=1,c_colors=255,title=VAR+' OBS DJF' &$;,position=[0.05,0.55,0.45,0.95] 
	contour,obs2d_mm(*,*,0),levels=rgrContValues,/fill,c_colors=rgrColValues,xstyle=1,ystyle=1,/overplot &$
	contour,landmask_com,xstyle=1,ystyle=1,/overplot,thick=0.5,color=255 &$

	contour,landmask_com,xstyle=1,ystyle=1,c_colors=255,title=VAR+' MODEL DJF' &$;,position=[0.05,0.55,0.45,0.95] 
	contour,tas2d_ave_mm(*,*),levels=rgrContValues,/fill,c_colors=rgrColValues,xstyle=1,ystyle=1,/overplot &$
	contour,landmask_com,xstyle=1,ystyle=1,/overplot,thick=0.5,color=255 &$

	contour,landmask_com,xstyle=1,ystyle=1,c_colors=255,title=VAR+' CORR DJF' &$;,position=[0.05,0.55,0.45,0.95] 
	contour,tasc2d_ave_mm(*,*),levels=rgrContValues,/fill,c_colors=rgrColValues,xstyle=1,ystyle=1,/overplot &$
	contour,landmask_com,xstyle=1,ystyle=1,/overplot,thick=0.5,color=255 &$
...
obs2d_com = FLTARR(nxm,nym,nmod,31.*NYEARS)
bias_com_tas2d = FLTARR(nxm,nym,nmod,31.*NYEARS)
bias_com_tasc2d = FLTARR(nxm,nym,nmod,31.*NYEARS)
ave_tas2d_com = FLTARR(nxm,nym,31.*NYEARS)
ave_tasc2d_com = FLTARR(nxm,nym,31.*NYEARS)
ave_bias_com_tas2d = FLTARR(nxm,nym,31.*NYEARS)
ave_bias_com_tasc2d = FLTARR(nxm,nym,31.*NYEARS)
tas2d_com_sm(*,*,*,*)=-999.
tasc2d_com_sm(*,*,*,*)=-999.
obs2d_com_sm(*,*,*,*)=-999.
bias_com_tas2d_sm(*,*,*,*)=-999.
bias_com_tasc2d_sm(*,*,*,*)=-999.
ave_tas2d_com_sm(*,*,*)=-999.
ave_tasc2d_com_sm(*,*,*)=-999.
ave_bias_com_tas2d_sm(*,*,*,*)=-999.
ave_bias_com_tasc2d_sm(*,*,*,*)=-999.
...
obsm2d_f = FLTARR(nx,ny);,ndays(im))
;tasm2d_f(*,*)=!VALUES.F_NAN
;tascm2d_f(*,*)=!VALUES.F_NAN
;obsm2d_f(*,*)=!VALUES.F_NAN
tasm2d_f(*,*)=-999.
tascm2d_f(*,*)=-999.
obsm2d_f(*,*)=-999.
...
print,obsm2d_f(lon_a(9000),lat_a(9000))
print,obsm2d_f(100,100)
FOR i=0L,NUMLANDPOINTS_c-1 DO BEGIN &$
	 ww=MEAN(tas_c(i,*),/NaN) &$
        ; tascm2d_f(lon_c(i),lat_c(i),*)=obs &$
...
;OBS'
contour,land2d_a,xstyle=1,ystyle=1,title='OBS '+month(im),position=[0.65,0.2,0.9,0.8],color=250
